...
public class Enemy : Entity
{
    ...
    // if you don't want enemy aggresive behind wall;
    //public virtual RaycastHit2D isPlayerDetected()
    //{
    //    float playerDistanceCheck = 50;

    //    RaycastHit2D playerDetected = Physics2D.Raycast(wallCheck.position, Vector2.right * facingDirection, playerDistanceCheck, whatIsPlayer);
    //    RaycastHit2D wallDetected = Physics2D.Raycast(wallCheck.position, Vector2.right * facingDirection, playerDistanceCheck +1, whatIsGround);
