...
public class Enemy_DeathBringer : Enemy
{
    ...
    public void FindPosition()
    {
        ...
        if(GroundBelow() == false || isSomethingAround())
        {
            Debug.Log("need new position");
            FindPosition();
        }
    ...
    private bool isSomethingAround() => Physics2D.BoxCast(transform.position, surroundingCheckSize,0,Vector2.zero, 0, whatIsGround);
