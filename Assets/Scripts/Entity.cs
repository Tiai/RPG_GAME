...
public class Entity : MonoBehaviour
{
    ...
    [SerializeField] Vector2 knockbackOffset = new Vector2(.5f,2);
    ...
    protected virtual IEnumerator HitKnockback()
    {
        ...
        //if(knockbackPower.x > 0 || knockbackPower.y > 0) //avoid player freeze by enemy's attack
    ...
    //draw a line to test player is grounded/walltouched... or not
